const defaultCatalog = {
    "FR001": {
        ...
        price: 1200,
        stock: 150,
        image: "img/productos/manzana-fuji.jpg",
    ...
    "FR002": {
        ...
        price: 1000,
        stock: 200,
        image: "img/productos/naranjas-valencia.png",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "FR003": {
        ...
        price: 800,
        stock: 250,
        image: "img/productos/platano-cavendish.jpg",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "VR001": {
        ...
        price: 900,
        stock: 100,
        image: "img/productos/zanahoria-organica.jpg",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "VR002": {
        ...
        price: 700,
        stock: 80,
        image: "img/productos/espinaca-fresca.jpg",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "VR003": {
        ...
        price: 1500,
        stock: 120,
        image: "img/productos/pimientos-tricolores.jpg",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "PO001": {
        ...
        price: 5000,
        stock: 50,
        image: "img/productos/miel-organica.webp",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "PO003": {
        ...
        price: 3000,
        stock: 3,
        image: "img/productos/quinoa-organica.jpg",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
    ...
    "PL001": {
        ...
        price: 1000,
        stock: 3,
        image: "img/productos/leche-entera.webp",
        gallery: ["img/not-found.svg", "img/not-found.svg"],
