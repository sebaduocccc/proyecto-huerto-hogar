document.addEventListener("DOMContentLoaded", () => {
    ...
    function actualizarComunas() {
        ...
        const regionSeleccionada = ubicaciones.regiones.find(
            r => r.region === selectRegion.value
        );
        ...
        regionSeleccionada.comunas.forEach(comuna => {
            ...
            newOpt.value = comuna;
            newOpt.textContent = comuna;
            selectComuna.appendChild(newOpt);
        });
    }



    ubicaciones.regiones.forEach(r => {
        const newOpt = document.createElement('option');
        newOpt.value = r.region;
        newOpt.textContent = r.region;
        selectRegion.appendChild(newOpt);
    });
